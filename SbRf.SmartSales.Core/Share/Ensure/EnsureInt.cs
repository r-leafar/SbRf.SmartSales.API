...
namespace SbRf.SmartSales.Core.Share.Ensure
{
    ...
    {
        public static void IsNonNegative(int value, [CallerArgumentExpression("value")] string? paramName = null)
        {
            if (value < 0)
            {
        ...
        public static void IsGreaterThanZero(int value, [CallerArgumentExpression("value")] string? paramName = null)
        {     
            if (value <= 0)
            {
